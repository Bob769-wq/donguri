...
@Component({
  ...
  template: `
    <section class="px-6 pt-20">
      ...
      <div class="grid grid-cols-4 gap-4 overflow-x-auto p-8">
        @for (item of kikiItems; track item.id) {
...
export class Kiki {
  kikiItems: KikiList[] = [
    {
      id: 1,
      title: '立體場景多用收納盒 魔女宅急便 彩繪玻璃花朵',
      price: 'NT$2,380',
      img: '/kiki/glass1.webp',
      img2: '/kiki/glass2.webp',
      link: '/color-glass',
    },
    {
      id: 2,
      title: '吊飾 吉吉的甜點 草莓果醬',
      price: 'NT$430',
      img: '/kiki/strawberry1.webp',
      img2: '/kiki/strawberry2.webp',
      link: '/strawberry',
    },
    {
      id: 3,
      title: '吊飾 吉吉的甜點 餅乾',
      price: 'NT$430',
      img: '/kiki/cookie1.webp',
      img2: '/kiki/cookie2.webp',
      link: '/cookie',
    },
    {
      id: 4,
      title: '晴雨兩用折疊傘 魔女宅急便 好多花朵',
      price: 'NT$1,800',
      img: '/kiki/umbrella1.webp',
      img2: '/kiki/umbrella2.webp',
      link: '/umbrella-flower',
    },
  ];
}
