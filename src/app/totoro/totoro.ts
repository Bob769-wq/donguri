...
<!--    TODO: 這個max-width是中間一整塊都是固定的，最好把這些有用到的component包在一起比較好，未來如果會調整的話比較好調整-->
    <section class="max-w-[1170px] mx-auto px-6 py-20">
      ...
      <div class="grid grid-cols-4 items-center gap-4 overflow-x-auto p-8">
        @for (item of totoroItems; track item.id) {
...
export class Totoro {
  totoroItems: TotoroList[] = [
    {
      id: 1,
      title: '日本職人注染布 龍貓 轉圈煙火',
      price: 'NT$750',
      img: '/totoro/hanabi.webp',
      link: '/hanabi',
    },
    {
      id: 2,
      title: '日本職人注染布 龍貓 風鈴',
      price: 'NT$690',
      img: '/totoro/ring1.webp',
      img2: '/totoro/ring2.webp',
      link: '/ring',
    },
    {
      id: 3,
      title: '日本職人注染布 龍貓 夏季蔬菜',
      price: 'NT$750',
      img: '/totoro/vegetable1.webp',
      img2: '/totoro/vegetable2.webp',
      link: '/vegetable',
    },
    {
      id: 4,
      title: '靠墊 龍貓 龍貓和草壁家',
      price: 'NT$1,100',
      img: '/totoro/house1.webp',
      img2: '/totoro/house2.webp',
      link: '/house',
    },
  ];
}
