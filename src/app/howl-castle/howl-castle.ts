  ...
  template: `
    <section class="px-6 py-20">
      ...
      <div class="grid grid-cols-4 items-center gap-4 overflow-x-auto p-8">
        @for (item of howlItems; track item.id) {
  ...
  howlItems: HowlList[] = [
    {
      ...
      title: '荷包蛋平底鍋 卡西法',
      price: 'NT$680',
      img: '/howl-castle/pan1.webp',
      img2: '/howl-castle/pan2.webp',
      link: '/pan',
    },
    {
      id: 2,
      title: '保冷袋 霍爾的移動城堡 卡西法',
      price: 'NT$540',
      img: '/howl-castle/cold1.webp',
      img2: '/howl-castle/cold2.webp',
      link: '/cold',
    },
    {
      id: 3,
      title: '厚棉手提包 霍爾的移動城堡 卡西法',
      price: 'NT$880',
      img: '/howl-castle/bag1.webp',
      img2: '/howl-castle/bag2.webp',
      link: '/bag',
    },
    {
      id: 4,
      title: '日期章 霍爾的移動城堡',
      price: 'NT$2,400',
      img: '/howl-castle/date1.webp',
      img2: '/howl-castle/date2.webp',
      link: '/date',
    },
  ];
}
